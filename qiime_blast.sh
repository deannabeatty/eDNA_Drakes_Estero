...
# activate qiime2
 ...
 # blast sequences 0.97 
 qiime feature-classifier classify-consensus-blast --i-query qza/rep_seqs_fish_2021_dada2.qza --i-reference-reads qza/12S-16S-18S-seqs.qza --i-reference-taxonomy qza/12S-16S-18S-tax.qza --o-classification qza/rep_seqs_fish_2021_dada2_mitofish_blast_taxonomy_12S_16S_18S_97.qza --p-perc-identity 0.97 --p-evalue 0.00001 

 # create qzv of output
 qiime metadata tabulate \
 --m-input-file qza/rep_seqs_fish_2021_dada2_mitofish_blast_taxonomy_12S_16S_18S_97.qza \
 --o-visualization qza/rep_seqs_fish_2021_dada2_mitofish_blast_taxonomy_12S_16S_18S_97.qzv
